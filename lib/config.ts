...
export const MODEL_CONFIG = {
    FAST_MODEL: process.env.NEXT_PUBLIC_FAST_MODEL || "gpt-4o-mini", // Fast model for quick operations
    QUALITY_MODEL: process.env.NEXT_PUBLIC_QUALITY_MODEL || "gpt-4o", // High-quality model for final synthesis
