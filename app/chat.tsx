...
function SourcesList({ sources }: { sources: Source[] }) {
    ...
    return (
        <>
            ...
            {/* Sources Panel */}
            <div
                className={`fixed inset-y-0 right-0 w-96 bg-white dark:bg-gray-900 border-l border-gray-200 dark:border-gray-700 transform transition-transform duration-300 ease-in-out ${
        ...
        const checkEnvironment = async () => {
            ...
            try {
                ...
                if (data.environmentStatus) {
                    // Firecrawl is considered configured if either the API key or a base URL (for self-hosting) is set
                    setHasApiKey(
                        data.environmentStatus.FIRECRAWL_API_KEY ||
                            data.environmentStatus.FIRECRAWL_BASE_URL,
                    );
                }
            } catch (error) {
                                                                      ...
                                                                      (
                                                                          ...
                                                                          >
                                                                              <div className="flex items-center justify-between">
                                                                                  ...
                                                                                  <svg
                                                                                      className="w-4 h-4 text-gray-400 group-hover:text-orange-500 flex-shrink-0 ml-2"
                                                                                      fill="none"
                                                                                      stroke="currentColor"
                                                                                      viewBox="0 0 24 24"
                                                                                  >
                        ...
                        <div className="p-4 border border-red-200 dark:border-red-800 bg-red-50 dark:bg-red-900/20 rounded-lg">
                            ...
                            {(errorMessage.includes("API key") ||
                                ...
                                <p className="text-red-600 dark:text-red-400 text-sm mt-2">
                                    ...
                                    <br />• ANTHROPIC_API_KEY (optional, for
                                    Claude)
                                    <br />• FIRECRAWL_API_KEY (can be provided
                                    via UI or env)
                                    <br />• FIRECRAWL_BASE_URL (optional, for
            ...
            <Dialog open={showApiKeyModal} onOpenChange={setShowApiKeyModal}>
                <DialogContent className="sm:max-w-[425px] bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            To use Firesearch, you need a Firecrawl API key or a
