...
| --------- | ---------------------------------- | -------------------------------------------------------------------- |
| Firecrawl | Web scraping (SaaS or Self-hosted) | [firecrawl.dev/app/api-keys](https://www.firecrawl.dev/app/api-keys) |
...
| -------------------- | ------------------------------------------- | --------------------------- |
| `FIRECRAWL_BASE_URL` | Base URL for self-hosted Firecrawl instance | `https://api.firecrawl.dev` |
| `ANTHROPIC_API_KEY`  | Use Claude 3.5 Sonnet for search planning   | -                           |
